...
export declare function checkTypeChange(pokemon: Pokemon, field: Field): void;
...
export declare function getPhotonGeyserCategory(offense: number, spoffense: number): MoveCategory;
export declare function getShellSideArmCategory(offense: number, defense: number, spoffense: number, spdefense: number): MoveCategory;
