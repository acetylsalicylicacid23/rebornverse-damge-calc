...
export declare function calculateAtModsSMSSSV(gen: Generation, attacker: Pokemon, defender: Pokemon, move: Move, field: Field, desc: RawDesc, attackerUseSpatk: boolean): number[];
...
export declare function calculateDfModsSMSSSV(gen: Generation, attacker: Pokemon, defender: Pokemon, move: Move, field: Field, desc: RawDesc, isCritical: boolean, hitsPhysical?: boolean, defenderUseSpatk: boolean): number[];
